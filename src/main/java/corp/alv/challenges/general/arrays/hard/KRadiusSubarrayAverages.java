package corp.alv.challenges.general.arrays.hard;
...
public class KRadiusSubarrayAverages {
    ...
    public static void main(String[] args) {
        ...
        int k = 3;
        System.out.println("For " + arrayToString(arr) + " is " + arrayToString(getAverages(arr, k)));


        arr = new int[] {7,4,3,9,1,8,5,2,6};
        k = 3;
        System.out.println("For " + arrayToString(arr) + " is " + arrayToString(getAverages(arr, k)));
    }
}
