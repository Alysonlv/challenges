    ...
    public int sumSubarrayMins(int[] arr) {
        ...
        for (int i = 0; i <= arr.length; i++) {
            ...
            while (!stack.empty() && (i == arr.length || arr[stack.peek()] >= arr[i])) {
                ...
                System.out.println("mid = " + mid + " | leftBoundary = " + leftBoundary + " | rightBoundary = " + rightBoundary);
                //Index of the minimum - left boundary * right boundary - Index of the minimum
                System.out.println("(" + mid + " - " + leftBoundary + ") * (" + mid + " - " + mid + ") = " + ((mid - leftBoundary) * (rightBoundary - mid)));
                long count = (mid - leftBoundary) * (rightBoundary - mid) % MOD;

                System.out.println("count = " + count + " arr[mid] = " + arr[mid]);
