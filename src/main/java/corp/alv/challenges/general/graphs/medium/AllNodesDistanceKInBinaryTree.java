...
public class AllNodesDistanceKInBinaryTree {
    ...
    public static void main(String[] args) {
        AllNodesDistanceKInBinaryTree t = new AllNodesDistanceKInBinaryTree();

        TreeNode node = null;

        node = BinaryTreeUtils.createBinaryTree(new Integer[]{3, 5, 1, 6, 2, 0, 8, null, null, 7, 4});
        System.out.println(t.distanceK(node, new TreeNode(5), 2));

        node = BinaryTreeUtils.createBinaryTree(new Integer[]{1});
        System.out.println(t.distanceK(node, new TreeNode(1), 3));
    }
}
